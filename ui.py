...
class GUI(tk.Frame):
    def __init__(self, master=tk.Tk()):
        ...
        self.url_Entry = tk.StringVar(value=self.previous_data["url"])
        ...
        self.username_Entry = tk.StringVar(value=self.previous_data["username"])
        ...
        self.password_Entry = tk.StringVar(value=self.previous_data["password"])
        ...
        self.domain_Entry = tk.StringVar(value=self.previous_data["domain"])
        ...
        self.project_Entry = tk.StringVar(value=self.previous_data["project"])
        ...
        self.instance_path_Entry = tk.StringVar(value=self.previous_data["path"])
