...
def main():
    ...
    try:
        ...
        try:
            ...
            print("Preparing data frame of {}".format(sheet_unique_execution_detail))
            raw_data_frame_unique = pdh.get_data_frame(file_path, sheet_unique_execution_detail)
            pivoted_data_frame_unique = pdh.pivot_data_frame_unique(raw_data_frame_unique)
            full_list_unique = pdh.unique_status_list
            data_frame_unique = pdh.format_pivot_data_frame(pivoted_data_frame_unique, full_list_unique)
            data_frame_unique = data_frame_unique.rename(columns={
            ...
            data_frame_unique = data_frame_unique.drop(['Failed', 'No Run'], axis=1)
            # Prepare total data frame
            print("Preparing data frame of {}".format(sheet_execution_detail))
            raw_data_frame_total = pdh.get_data_frame(file_path, sheet_execution_detail)
            pivoted_data_frame_total = pdh.pivot_data_frame_total(raw_data_frame_total)
            full_list_total = pdh.full_status_list
            data_frame_total = pdh.format_pivot_data_frame(pivoted_data_frame_total, full_list_total)
            data_frame_total = data_frame_total.rename(columns={
            ...
            data_frame_total = data_frame_total.drop(['Failed', 'No Run', 'NA', 'Block', 'Not Completed'], axis=1)
